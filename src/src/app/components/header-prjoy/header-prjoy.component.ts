...
@Component({
  selector: 'app-header-prjoy',
  templateUrl: './header-prjoy.component.html',
  styleUrls: ['./header-prjoy.component.scss']
})
export class HeaderPrjoyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sharedValueService.getSettingMenuPr().subscribe((categories: any) => {
