...
@Component({
  selector: 'app-ph0018-page',
  templateUrl: './ph0018-page.component.html',
  styleUrls: ['./ph0018-page.component.scss']
})
export class Ph0018PageComponent implements OnInit, AfterViewInit {
  numTab: any;
  page: number;
  const: any = {};
  allPage: any[] = [];
  ...
  getTracingReportStatics() {
    ...
    tracingReport.start = date.format('YYYY-MM-01T00:00:00ZZ');
    tracingReport.page = this.page;
    tracingReport.pageSize = 20;
  ...
  getTracingReportStaticsCsv(dataList) {
    ...
    const header = [this.msgStore['PHARMACY.PH0018'].OFFICE_NAME, this.msgStore['PHARMACY.PH0018'].PATIENT_CONSENT_YES,
      this.msgStore['PHARMACY.PH0018'].PATIENT_CONSENT_NO, this.msgStore['PHARMACY.PH0008'].SUM];
    const options = {
      fieldSeparator: ',',
      quoteStrings: '"',
      decimalseparator: '.',
  ...
  getChangesInPrescriptionCsv(dataList) {
    ...
    const header = [this.msgStore['PHARMACY.TRACING_REPORT'].DRUG_STORE_NAME, this.msgStore['PHARMACY.PH0018'].RESIDUE_ADJUSTMENT,
      this.msgStore['PHARMACY.PH0018'].CHANGE_COMPONENT, this.msgStore['PHARMACY.PH0018'].CHANGE_OF_DOSAGE,
      this.msgStore['PHARMACY.PH0018'].STANDARD_CHANGE, this.msgStore['PHARMACY.PH0018'].ONE_PACKAGING,
      this.msgStore['PHARMACY.PH0018'].PRESCRIPTION_DAY, this.msgStore['PHARMACY.PH0018'].CHANGE_GENERA_DRUG,
      this.msgStore['PHARMACY.PH0018'].OTHER, this.msgStore['PHARMACY.PH0008'].SUM,
