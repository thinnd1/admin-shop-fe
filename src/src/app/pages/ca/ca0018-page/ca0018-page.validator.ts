...
@Injectable()
export class Ca0018PageValidator {
  repeatOption: any;
  recursiveOption = {
    'ONE': 'THIS_EVENT',
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private ca0018PageRRule: Ca0018PageRrule) {
  ...
  checkValidate(editEventForm: FormGroup, validationError, formErrorMessage) {
    ...
    if (repeatOption !== this.ca0018PageRRule.repeatOption.no_repeat && endDate === this.ca0018PageRRule.endDate.count_time) {
    ...
    if (repeatOption === this.ca0018PageRRule.repeatOption.week) {
  ...
  mapModelInput(modelInput: EventCreateSettings, formModel, translate) {
    ...
    const obj = this.ca0018PageRRule.repeatRuleConfig(valueRRule, optionRRule, formModel.startDay);
