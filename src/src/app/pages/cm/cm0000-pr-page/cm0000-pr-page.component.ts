...
@Component({
  selector: 'app-cm0000-pr-page',
  templateUrl: './cm0000-pr-page.component.html',
  styleUrls: ['./cm0000-pr-page.component.scss']
})
export class Cm0000PrPageComponent implements OnInit {
