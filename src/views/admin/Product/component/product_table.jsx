    ...
    <>
      <div style={{ position: 'relative', top: '4.3rem' }}>
        <div className='flex justify-between p-4'>
          ...
          <Link className='border_btn text-s text-white font-semi-bold rounded p-2 flex items-center' style={{ backgroundColor: '#5969ed' }} to="http://localhost:5000/shop/product/create">Add new product</Link>
        </div>
